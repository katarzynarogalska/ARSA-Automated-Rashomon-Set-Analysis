...
class arsa_ml.rashomon_intersection<strong>RashomonIntersection</strong>(leaderboard, predictions, proba_predictions, feature_importances, metrics, epsilon, custom_weights, weighted_sum_method)
</div>
</br>
