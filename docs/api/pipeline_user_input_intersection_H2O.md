...
class arsa_ml.pipelines.pipelines_user_input.<strong>BuildRashomonIntersectionH2O</strong>(models_directory, test_data, target_column, df_name, metrics, custom_weights, weighted_sum_method, delta, feature_imp_needed, converter_results_directory)
</div>
</br>
